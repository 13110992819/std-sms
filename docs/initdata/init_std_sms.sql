...
INSERT INTO `tjc_company` VALUES ('CD-YLQ000013', '一两千', '一两千');
INSERT INTO `tjc_configure` (`company_code`,`channel`,`k`,`v`,`remark`)  VALUES ('CD-YLQ000013', 'CSMD', 'csmd_sn', 'SDK-JDH-010-00046', 'account');
INSERT INTO `tjc_configure` (`company_code`,`channel`,`k`,`v`,`remark`)  VALUES ('CD-YLQ000013', 'CSMD', 'csmd_password', 'df9f0e__', 'password');
INSERT INTO `tstd_system_channel` (`system_code`,`channel_type`,`push_type`,`status`,`push_system`,`private_key1`,`private_key2`,`private_key3`,`remark`) VALUES ('CD-YLQ000013','1','11','1','','SDK-JDH-010-00046','df9f0e__','','一两千');
